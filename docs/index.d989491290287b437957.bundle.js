...
var resultAirplane = document.querySelectorAll(".result-airplane"); // baggage section
...
var btnPrice = document.getElementById('btnPrice'); // console.log(departureDate.value);
...
function chooseSeat() {
  ...
  list.forEach(function (e) {
    return e.addEventListener("click", function (e) {
      ...
      var seat1 = e.target.parentElement.parentElement.classList; // console.log(seat1.value);
      ...
      e.target.parentElement.parentElement.classList[0]; // console.log(Seats);

      airportData.trip.seatsreservd = Seats;
      var lista = Seats.join(', '); // console.log(lista);
