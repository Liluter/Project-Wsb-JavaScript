...
var actWeatherData = {};
var navWeatherStatus = document.getElementById("location-weather"); // function actWeatherNav() {
...
weatherIcon.setAttribute("src", weatherIcons.clear); // console.log(weatherIcon.getAttribute('src'));
...
var footerLinksDest = document.getElementsByClassName("footerLinksDest"); // const footerLinksDepart = document.getElementsByClassName('footerLinksDepart');
...
var baggageBtn = document.getElementById("btnBaggage"); // baggage section
...
var setPlace = document.getElementById('set-place'); // console.log(departureDate.value);
...
acceptDest.addEventListener("click", function () {
  ...
  setLink(tempDest.Write()); // console.log(footerLinksDest);
...
acceptDepart.addEventListener("click", function () {
  ...
  setLink(tempDepart.Write()); // console.log(footerLinksDepart);
...
var zapiszData = function zapiszData(data, where) {
  ...
  console.log("Sprawdzenie odczyt: ", airportData.where, airportData); // console.log("co jest w select Dest:", selectDest.value);
  // console.log("co jest w selectDepart:", selectDepart.value);
  // console.log("airportData dest", airportData);

  departureDate.setAttribute("min", calTomorrow); // console.log(departureDate.value);
...
acceptArrivalDateBtn.addEventListener("click", function () {
  ...
  if (airportData.trip.arrivaldate != "" && airportData.trip.departuredate != "") {
    ...
    resultTripLength[0].textContent = airportData.trip.length; // airportData.trip.length = airportData.trip.departuredate - airportData.trip.arrivaldate
  }
}, false);
...
decPassNr.addEventListener("click", function () {
  ...
  resultPassNum.textContent = airportData.passengers; // resultPassNum.textContent = passNum.value.toString();
...
incPassNr.addEventListener("click", function () {
  ...
  passNum.value++;
  airportData.passengers = passNum.value;
  resultPassNum.textContent = airportData.passengers; // console.log(resultPassNum.textContent);
  // console.log(passNum.value , airportData.passengers)
}, false);
...
function CheckPass() {
  ...
  var arrEmail = airportData.users.map(function (e) {
    return e.email;
  });
  var arrPass = airportData.users.map(function (e) {
    return e.password;
  ...
  if (arrName.some(function (name) {
    ...
    if (airportData.users.find(function (user) {
      ...
      console.log("zły email ", airportData.users.find(function (user) {
        return user.name == loginName.value;
      }).email);
      ...
      if (airportData.users.find(function (user) {
        ...
        console.log("logged in... as ", loginName.value); // funkcja szczegółów i awatara.
...
function chooseSeat() {
  ...
  list.forEach(function (e) {
    return e.addEventListener("click", function (e) {
      ...
      console.log(parent.classList.contains('selected')); // console.log(parent.classList);
...
chooseSeat();
console.log(Seats); // const loginName = document.getElementById('login-name');
...
/******/ })()
;
//# sourceMappingURL=index.d2d7a99ab4d070336fd8.bundle.js.map