...
var user = "Karol"; // conecting via dataset
...
var result = document.getElementById("show-dest");
var acceptDest = document.getElementById("set-dest");
var resultDest = document.getElementById("result-dest");
var resultDest2 = document.getElementById("btn-label-depart");
...
acceptDest.addEventListener("click", function () {
  var tempDest = new Where(selectDest.value); // result.textContent = tempDest.Write();

  console.log("zakceptowano : ", selectDest.value); // resultDest.textContent = tempDest.Write();
...
/******/ })()
;
//# sourceMappingURL=index.ced08db111ac5402cf2b.bundle.js.map