...
console.log(currentDate); // console.log(currentData.toLocaleDateString().split('.'));
...
acceptDepart.addEventListener("click", function () {
  ...
  console.log(footerLinksDepart); // footerLinks.forEach((e) => e.classList.toggle('show'));
...
/******/ })()
;
//# sourceMappingURL=index.facc6385cb160f8688c1.bundle.js.map